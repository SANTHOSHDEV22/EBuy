<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DatepickerSelect2.aspx.cs" Inherits="EBuy.Pages.DatepickerSelect2" %>
        ...
        <div class="container-fluid justify-content-between p-4">
            <div class="row">
                ...
                <div class="col-md-4 d-flex justify-content-center align-items-center">
                    <p class="h2">Admin Register</p>
                </div>
                <div class="col-md-4 d-flex justify-content-end align-items-center">
                    <input id="pageSwitch" type="checkbox" checked="checked" data-toggle="toggle" data-on="Admin" data-off="User" data-onstyle="primary" data-offstyle="light" data-style="ios" />
                </div>
            </div>
        </div>
        ...
        $(document).ready(function () {
            ...
            const pageSwap = () => {
                ...
                switch1.on('change', function () {
                    if ($(this).is(':checked')) {
                        setTimeout(function () {
                            window.location.href = "DatepickerSelect2.aspx";
                        }, 300);
                    } else {
                        setTimeout(function () {
                            window.location.href = "iframeApply.aspx";
                        }, 300);
                    }
                });
            }
