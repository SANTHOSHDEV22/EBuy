<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterDTDom.aspx.cs" Inherits="EBuy.RegisterDTDom" %>
<!DOCTYPE html>
    ...
    <script>
        $(document).ready(function () {
            ...
            const submitModalForm = (event) => {
                ...
                if (!isServerOk) { showerror("Server has been down!"); return; }
                let userData = {
            ...
            const loadUserTable = () => {
                ...
                table = $("#modalUserTable").DataTable({
                    ...
                    dom: '<"row"<"col-12"<"dt-filter-btn">>><"row"<"col-md-12"P>><"row"<"col-md-6"l><"col-md-6 d-flex justify-content-end"<"dt-export-btn">f>><"d-none"B>t<"row"<"col-md-6"i><"col-md-6 d-flex justify-content-end"p>>',
                    searchPanes: {
                        viewCount: true,
                        cascadePanes: true,
                        layout: "columns-3",
                    ...
                    buttons: [
                        {
                            ...
                            action: function () {
                                $('.dtsp-searchPanes').slideToggle(200);
                            }
                        },
                        {
                            extend: "collection",
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            className: "text-center align-middle",
                            render: function () {
                                return `<button type="button" class="btn btn-sm btn-outline-primary updateBtn" title="Edit User">
                    ...
                    initComplete: function () {
                        ...
                        const filterBtn = btnContainer.find('.dt-buttons button:contains("Filters")').detach();
                        const exportBtn = btnContainer.find('.dt-buttons button:contains("Export")').detach();
                        btnContainer.find('.dt-filter-btn').append(filterBtn);
                        btnContainer.find('.dt-export-btn').append(exportBtn);
                        setTimeout(function () {
            ...
            $("#updateUserBtn").on("click", function () {
                ...
                if (existingUser.firstName) {
                    updatedUser = {
                        ...
                        fullName: `${updatedUser.fname} ${updatedUser.lname}`.trim(),
                        normalizedPass: updatedUser.pass
                    };
                } else {
                    updatedUser.fullName = `${updatedUser.fname} ${updatedUser.lname}`.trim();
                    updatedUser.normalizedPass = updatedUser.pass;
                }
